...
st.write("Click the button to prepare the latest available market data outside Docker and generate a forecast.")
...
if "prediction" in st.session_state:
    ...
    st.info("Start the local Docker API, then click **Generate New Prediction**.")
